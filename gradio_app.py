...
# Download fine-tuned model checkpoint
...
def restore_monument(editor_data):
    ...
    # Format Tensors for DeepFill v2
    ...
    # Return mask preview and restored image
...
with gr.Blocks(title="Monument Image Restoration") as demo:
    ...
    gr.Markdown("Upload a damaged monument image, paint over the cracks/damage with the brush (eraser tool included), and click **Restore Monument**.")
